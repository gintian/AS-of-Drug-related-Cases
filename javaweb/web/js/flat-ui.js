...
$.extend( $.ui, {
	// $.ui.plugin is descript. Use $.widget() extensions instead.
	plugin: {
        ...
        return function (query) {
            ...
            timeout = window.setTimeout(function () {
                var data = options.data, // ajax data function
                    ...
                    // descript - to be removed in 4.0  - use params instead
                    descript = {
                    ...
                    params = $.extend({}, $.fn.select2.ajaxDefaults.params, descript);
...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		/**
		 * __descript__ The functionality provided by this parameter has now been
		 ...
		 *
		 *  @descript 1.10. Please use `ajax` for this functionality now.
		 */
		"fnServerData": null,
	...
	DataTable.models.oSettings = {
		 ...
		 * callback if filtering has been done in the draw. descript in favour of
		 * events.
		 *  @type boolean
		 *  @default false
		 *  @descript
		...
		/**
		 * Flag attached to the settings object so you can check in the draw
		 * callback if sorting has been done in the draw. descript in favour of
		 * events.
		 *  @type boolean
		 *  @default false
		 *  @descript
